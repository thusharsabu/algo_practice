...
from Fundamentals.tree import Node
...
def diameter_of_binary_tree(root):
    ...
    return diameter_func(root.get_left_child) + diameter_func(root.get_right_child)


def diameter_func(root):
    if root is None:
        return 0

    return (
        max(diameter_func(root.get_left_child), diameter_func(root.get_right_child)) + 1
    )
...
#     left_height, left_diameter = diameter_of_binary_tree_func(root.get_left_child)
#     right_height, right_diameter = diameter_of_binary_tree_func(root.get_right_child)
...
# print(diameter_of_binary_tree(tree.get_root()))


class BinaryTreeNode:
    def __init__(self, data):
        self.get_left_child = None
        self.get_right_child = None
...
def convert_arr_to_binary_tree(arr):
    ...
    while not queue.empty():
        ...
        if left_child is not None:
            ...
            current_node.get_left_child = left_node
            queue.put(left_node)
        ...
        if right_child is not None:
            ...
            current_node.get_right_child = right_node
